...
class ActivityCode(db.Model):
    ...
    code_scope = db.Column(db.String(50), default='global')
    code_type = db.Column(db.String(100), nullable=False)
    code_value = db.Column(db.String(50), nullable=False)
    code_description = db.Column(db.String(200))
    code_color = db.Column(db.String(20), default='#4361ee')
    ...
    __table_args__ = (
        Index('idx_activity_code_org', 'org_id'),
        Index('idx_activity_code_type', 'code_type'),
        Index('idx_activity_code_scope', 'code_scope'),
    )
